 ...
 * @author Skrzypek
 */
public class MovieAwardExtractor implements FeatureExtractor {
    ...
    public void prepareData() {
        try {
            input = new FileInputStream("src\\structures\\extractors\\config\\movieAward.properties");
