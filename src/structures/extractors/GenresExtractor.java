 ...
 * @author Skrzypek
 */
public class GenresExtractor implements FeatureExtractor {
    ...
    public void prepareData() {
        try {
            input = new FileInputStream("src\\structures\\extractors\\config\\genres.properties");
